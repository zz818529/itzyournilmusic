...
ALIVE_PIC = START_PIC
HOME_TEXT = " **ʜᴇʟʟᴏ s[{}](tg://user?id={})** \n\n**ᴛʜɪꜱ ʙᴏᴛ ʜᴀꜱ ᴀ ʟᴏᴛ ᴏꜰ ꜰᴇᴀᴛᴜʀᴇꜱ ʙᴀꜱᴇᴅ ᴏɴ ᴀ.ɪ ᴀɴᴅ ʜɪɢʜ ꜱᴏᴜɴᴅ Qᴜᴀʟɪᴛʏ ᴏꜰ ꜱᴏɴɢꜱ.**  ᴘᴏᴡᴇʀᴇᴅ ʙʏ [⏤͟͞🇧🇩 𝔻𝕒𝕣𝕜 ℕ𝕚𝕝](t.me/itzyournil)**"
HELP_TEXT = """ᴛʜɪꜱ ʙᴏᴛ ʜᴀꜱ ᴀ ʟᴏᴛ ᴏꜰ ꜰᴇᴀᴛᴜʀᴇꜱ ʙᴀꜱᴇᴅ ᴏɴ ᴀ.ɪ ᴀɴᴅ ʜɪɢʜ ꜱᴏᴜɴᴅ ǫᴜᴀʟɪᴛʏ ᴏꜰ ꜱᴏɴɢꜱ  ᴘᴏᴡᴇʀᴇᴅ ʙʏ [⏤͟͞🇧🇩 𝔻𝕒𝕣𝕜 ℕ𝕚𝕝](t.me/itzyournil)
» **sᴇᴛᴜᴘ ɢᴜɪᴅᴇ** :
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data=="help":
        buttons = [
            [
                InlineKeyboardButton("👮 ᴏᴡɴᴇʀ", url="https://t.me/itzyournil"),
        ...
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton("📢 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/itzyournil"),
            ],
            [
                InlineKeyboardButton("♨️ sᴏᴜʀᴄᴇ Cᴏᴅᴇ", url="https://t.me/itzyournil"),
            ],
            [
